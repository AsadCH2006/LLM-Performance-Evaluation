...
1. Primary cause and quantitative scale.
2. Direct socioeconomic impacts.
3. Systemic adaptation barriers.
...
1. Clone this repository:
   ...
   ```
2. Inspect the raw text and evaluation prompts located in the `src/` directory.
3. Test prompts against target LLM provider APIs or playgrounds to evaluate model behaviors.
